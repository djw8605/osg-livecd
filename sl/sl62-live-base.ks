...
services --enabled=NetworkManager,condor --disabled=network,sshd,bwctld
...
gconftool-2 --direct --config-source=xml:readwrite:/etc/gconf/gconf.xml.defaults -t str -s /desktop/gnome/background/picture_options "zoom"
